...
public class Tela_exclusao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        button_pesquisar1 = new javax.swing.JToggleButton();
        ...
        button_emprestar.setBounds(320, 190, 100, 23);
        ...
        jScrollPane1.setBounds(20, 220, 590, 320);

        jLabel1.setText("Editar");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(-80, 0, 700, 540);

        button_pesquisar1.setText("Pesquisar");
        button_pesquisar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                button_pesquisar1ActionPerformed(evt);
            }
        });
        getContentPane().add(button_pesquisar1);
        button_pesquisar1.setBounds(360, 160, 80, 23);
    ...
    if (confirm == JOptionPane.YES_OPTION) {
        try {
            ...
            button_pesquisar1ActionPerformed(evt); // Chama o método de pesquisa para atualizar a tabela
    ...
    private javax.swing.JToggleButton button_pesquisar1;
    ...
    // End of variables declaration//GEN-END:variables
         ...
         String titulo,autor,genero,editora,isbn,anoPublicacao,numeroPaginas;
         ...
         anoPublicacao = input_ano.getText();   
         numeroPaginas = input_numero.getText();   
         ...
         ConexaoLivro livro2 = new ConexaoLivro();
         livro2.editarLivro(livro);
